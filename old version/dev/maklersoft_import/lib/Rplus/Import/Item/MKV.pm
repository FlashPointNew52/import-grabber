...
sub _get_item {
    ...
    my $raw_data = $user_agent->inactivity_timeout(0)->connect_timeout(45)->request_timeout(0)->get('http://localhost:9000/get_media_data?url=https://mirkvartir.ru'.$item_url.'&ip='.$ip)->res->{'buffer'};
